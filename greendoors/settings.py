...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'frome2014/static'),
    os.path.join(PROJECT_ROOT, 'frome2014/sass'),
    os.path.join(PROJECT_ROOT, 'south_wiltshire_2014/static'),
    os.path.join(PROJECT_ROOT, 'south_wiltshire_2014/sass'),
    os.path.join(PROJECT_ROOT, 'bristol2013/static'),
    os.path.join(PROJECT_ROOT, 'bristol2014/static'),
    os.path.join(PROJECT_ROOT, 'bristol2014/sass'),
...
ROOT_URLCONF = 'greendoors.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'greendoors.wsgi.application'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'frome2014/templates'),
    os.path.join(PROJECT_ROOT, 'bristol2013/templates'),
    os.path.join(PROJECT_ROOT, 'data/report_templates'),
    os.path.join(PROJECT_ROOT, 'south_wiltshire_2014/templates'),
)
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'bristol2014.pipeline.send_message_on_social_registration',
...
LOGGING = {
    ...
    'handlers': {
        'default': {
            ...
            'filename': logs_folder + 'greendoors.log',
