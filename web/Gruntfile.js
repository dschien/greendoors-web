...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            copy: {
                build: {
                    files: [
                        {dest: "<%= targetdir%>/lib/", src: ["**"], cwd: 'bower_components/bootstrap/dist/', expand: true},
                        {dest: "<%= targetdir%>/lib/", src: ["**"], cwd: 'bower_components/jquery/dist/', expand: true},
                        {dest: "<%= targetdir%>/lib/", src: ["underscore.min.js"], cwd: 'bower_components/underscore/', expand: true},
