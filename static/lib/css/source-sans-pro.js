...
(function (window, document, undefined) {
    ...
    q.prototype.createElement = function (a, c, b) {
        ...
        if (c)for (var e in c)c.hasOwnProperty(e) && ("style" == e ? this.za(a, c[e]) : a.setAttribute(e, c[e]));
    ...
    function u(a, c) {
        for (var b = a.className.split(/\s+/), e = 0, d = b.length; e < d; e++)if (b[e] == c)return;
        b.push(c);
    ...
    function aa(a, c) {
        for (var b = a.className.split(/\s+/), e = 0, d = b.length; e < d; e++)if (b[e] == c)return k;
        return m
    }
    ...
    ba.prototype.parse = function () {
        ...
        if (-1 != this.j.indexOf("MSIE")) {
            ...
            } else a = new w("MSIE", "Unknown", "MSIE", "Unknown", a, c, B(this.A))
        } else if (-1 != this.j.indexOf("Opera"))a:if (c = a = "Unknown", b = z(this.j, /(Presto\/[\d\w\.]+)/, 1), "" != b ? (c = b.split("/"), a = c[0], c = c[1]) : (-1 != this.j.indexOf("Gecko") && (a = "Gecko"), b = z(this.j, /rv:([^\)]+)/, 1), "" != b && (c = b)), -1 != this.j.indexOf("Opera Mini/"))b =
            z(this.j, /Opera Mini\/([\d\.]+)/, 1), "" == b && (b = "Unknown"), a = new w("OperaMini", b, a, c, x(this), y(this), B(this.A)); else {
    ...
    function y(a) {
        ...
        if (c || (c = z(a.j, /Windows Phone( OS)? ([^;)]+)/, 2)))return c;
        if (c = z(a.j, /(iPhone )?OS ([\d_]+)/, 2))return c;
    ...
    E.prototype.watch = function (a, c, b, e, d) {
        ...
        d && (this.qa = d);
        for (h = 0; h < f; h++)for (var i = a[h], d = c[i], j = b[i], C = 0, Ia = d.length; C < Ia; C++) {
    ...
    function H(a, c, b) {
        c = a.l.createElement("span", {style: na(a, c, a.X, b)}, a.Ja);
        r(a.l, "body", c);
        return c
    }
    ...
    var oa = ["font-style", "font-weight"], pa = {"font-style": [
        ["n", "normal"],
        ["i", "italic"],
        ["o", "oblique"]
    ], "font-weight": [
    ...
    qa.prototype.expand = function (a, c) {
        for (var b = 0; b < this.M.length; b++)if (c == this.M[b][0]) {
    ...
    function ra(a, c, b) {
        ...
        if (e) {
            ...
            d.onload = d.onreadystatechange = function () {
                if (!f && (!this.readyState || "loaded" == this.readyState || "complete" == this.readyState))f = k, b && b(), d.onload = d.onreadystatechange = l, "HEAD" == d.parentNode.tagName && e.removeChild(d)
            };
            e.appendChild(d)
        }
    }
    ...
    function sa() {
        var a = [
            {name: "font-family", value: K.c[L + 1]}
        ];
        this.Va = [K.c[L]];
        this.ka = a
    }
    ...
    function ua(a, c, b) {
        for (var e = [], d = a.I.split(",")[0].replace(/"|'/g, ""), f = a.F(), h, i = [], j = {}, C = 0; C < f.length; C++)h = f[C], 0 < h.length && !j[h] && (j[h] = k, i.push(h));
        b = b.xa ? b.xa(d, i, e) : i;
        c = c.Q;
        a.ma[c] = b;
        a.la[c] = e
    ...
    function va(a, c, b, e) {
        ...
        for (c = 0; c < a.length; c++) {
            for (var d = a[c], f = d.I, h = m, i = 0; i < b.length; i++)b[i] == f && (h = k);
            h || (b.push(f), e[f] = d.F())
        }
    }
    ...
    o.init = function () {
        if (0 < this.N.length) {
            for (var a = [], c = 0; c < this.N.length; c++)a.push(ta(this.N[c]));
    ...
    o.load = function (a, c) {
        var b = this.u.Q;
        if (this.Z)for (var e = Ca(this.Z, b), d = 0; d < this.r.length; d++)ua(this.r[d], this.u, e);
        ...
        a && s(function (a, b, c, d) {
            return function () {
                for (var e = 0; e < a.r.length; e++)a.r[e].watch(b, c, d && e == a.r.length - 1)
            }
        }(this, a, this.u, c))
    };
    o.collectFontFamilies = function (a, c) {
        for (var b = 0; b < this.r.length; b++)va(this.r[b], this.u, a, c)
    };
        ...
        this.ca && s(function (a, b, e, d) {
            return function () {
                ...
                if (b.va) {
                    ...
                    xa(b.va.m(J(d), {host: encodeURIComponent(d.n.location.hostname), app: encodeURIComponent(h), _: (+new Date).toString()}))
                }
                b = a.ca;
    ...
    Q.prototype.load = function (a, c) {
        var b = a, e = c || {};
        if ("string" == typeof b)b = [b]; else if (!b || !b.length)e = b || {}, b = [];
        if (b.length)for (var d = this, f = b.length, h = 0; h < b.length; h++)Ga(this, b[h], function () {
            0 == --f && Ha(d, e)
        }); else Ha(this, e)
    };
    function Ga(a, c, b) {
        ra(a.l, a.Qa.m(J(a.l), {id: encodeURIComponent(c)}), b)
    }

    function Ha(a, c) {
        if (0 != a.t.length) {
            for (var b = new da(a.l, a.o, c), e = m, d = 0; d < a.t.length; d++)a.t[d].init(), e = e || a.t[d].supportsConfiguredBrowser();
    ...
    function Ja(a, c) {
        ...
        for (var e = new E(a.l, c, {aa: function (a) {
    ...
    R.prototype.load = function () {
        ...
        if (a)for (var c = 0; c < this.t.length; c++) {
    ...
    Na.prototype.toString = function () {
        for (var a = [], c = 0; c < this.r.length; c++)for (var b = this.r[c], e = b.F(), b = b.F(this.u), d = 0; d < e.length; d++) {
            var f;
            a:{
                for (f = 0; f < b.length; f++)if (e[d] === b[f]) {
                    f = k;
                    break a
                }
                f = m
    ...
    function Fa(a, c) {
        for (var b = [], e = 0; e < c.length; e++)b.push(c[e].toString());
    ...
    function Pa(a, c, b) {
        var e = 0, d = 0, a = a.n;
        if (a.documentElement && (a.documentElement[c] || a.documentElement[b]))e = a.documentElement[c], d = a.documentElement[b]; else if (a.body && (a.body[c] || a.body[b]))e = a.body[c], d = a.body[b];
        return[e, d]
    }
    ...
    P(new N("a", function (a, c, b, e, d, f) {
        if (m || ("Windows" == d && "Unknown" == f ? k : m) || ("Ubuntu" == d || "Linux" == d ? k : m))a:{
    ...
    P(new N("a", function (a, c, b, e, d, f, h, i) {
        ...
        j = (j = m || function (a, b, c, e, d, f, h, i) {
            ...
            if (i.L && ("iPhone" == d || "iPod" == d))if (a = /^([0-9]+)_([0-9]+)/.exec(f))return b = parseInt(a[2], 10), 4 == parseInt(a[1], 10) && 2 <= b;
            return m
        }(a, c, b, e, d, f, h, i);
        return!j ? m : function (a, b) {
            if ("Chrome" == a) {
    ...
    P(new N("i", function (a, c, b, e, d, f, h, i) {
        ...
        return!j ? m : function (a, b, c, e, d, f, h) {
            if ("MSIE" == a)return(a = /([0-9]+.[0-9]+)/.exec(b)) ? 6 <= parseFloat(a[1]) && (h === g || 9 > h) : m
        }(a, c, b, e, d, f, h, i)
    }));
    P(new N("d", function (a, c, b, e, d, f, h) {
        if (!(c = m))b = /^([0-9]+).([0-9]+)/.exec(f), "Windows" == d && b ? (c = parseInt(b[1], 10), b = parseInt(b[2], 10), c = 6 < c || 6 == c && 1 <= b) : c = m;
        a = c || ("Windows" == d && "6.0" == f ? k : m) ? "MSIE" == a ? 9 <= h : g : m;
        return a
    }));
    P(new N("d", function (a, c, b, e, d, f, h, i) {
        if (!(c = m))f = /^([0-9]+)/.exec(f), c = i.Ca && "Windows Phone" == d && f ? 8 <= parseInt(f[1], 10) : m;
        return!c ? m : "MSIE" == a
    }));
    P(new N("a", function (a, c, b, e, d, f, h, i) {
        var j;
    ...
    P(new N("a", function (a, c, b, e, d, f, h, i) {
        ...
        j = (j = (j = m || function (a, b, c, e, d, f, h, i) {
            ...
            if (i.L && ("iPhone" == d || "iPod" == d))if (a = /^([0-9]+)_([0-9]+)/.exec(f))return b = parseInt(a[2], 10), 4 ==
                parseInt(a[1], 10) && 2 <= b;
            return m
        }(a, c, b, e, d, f, h, i);
    ...
    P(new N("f", function (a, c, b, e, d, f, h, i) {
        if (!(c = m))f = /([0-9]+).([0-9]+)/.exec(f), i.D && "Android" == d && f ? (i = parseInt(f[1], 10), f = parseInt(f[2], 10), c = 3 == i && 1 <= f || 3 < i) : c = m;
    ...
    Ka(new S("DefaultFourFontsWithSingleFvdFamilies", function (a, c, b) {
        ...
        e = [];
        for (d = 0; d < b.length; d++)for (var f = b[d], h = 0; h < f.length; h++) {
            var i = f[h];
            if (a[i]) {
                e = e.concat(a[i]);
                break
    ...
    var L;
    if (K.fn)for (L = 0; L < K.fn.length; L += 2)$.r.push(new M(K.fn[L], K.fn[L + 1]));
    if (K.c)for (L = 0; L < K.c.length; L += 2)$.N.push(new sa);
    $.U = W;
    $.S = za;
    $.Z = T;
